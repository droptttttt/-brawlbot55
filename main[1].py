...
API_TOKEN = '8175304712:AAE61ccFBdA_6Bqb9fQ1E2sG5RJd-UFuHBs'
...
def open_box(message):
    ...
    reward = 0.01 if random.randint(1, 100) <= 99 else 10
...
@bot.message_handler(func=lambda msg: msg.text == "⚙️ Админ-панель" and msg.from_user.id == ADMIN_ID)
